...
export class TransferDto {
  @ApiProperty({
    description:
      'The unique request id of the transfer request. It will be used when sending the status of the transaction. If not passed, a request id will be generated automatically',
    required: false,
    example: 'TRANSFER1665216684701',
  })
  @IsDefined()
  ...
  @ApiProperty({
    description: 'The address of the wallet to receive the tokens',
    required: true,
  ...
  @ApiProperty({
    description:
      'The amount of tokens to be transferred in the wallet address of the user',
    required: true,
    example: 100,
  })
  @IsDefined()
